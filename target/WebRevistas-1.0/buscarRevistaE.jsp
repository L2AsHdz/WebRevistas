...
<html>
    ...
    <body>
            ...
            <table class="table w-75 p-3">
                ...
                <tbody>
                    ...
                    %><tr>
                        ...
                        <td><button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#p<%=rs2.getString(1)%>">Previsualizar</button></td>
                    </tr><%}
                        } catch (Exception e) {}%>
        ...
        <form action="suscripcionRevista.jsp" method="POST">
            <div class="modal fade" id="p<%=rs3.getString(1)%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="id" value="<%=rs3.getString(1)%>" >Suscribirse</button>
                        </div>
                    </div>
                </div>
            </div>
